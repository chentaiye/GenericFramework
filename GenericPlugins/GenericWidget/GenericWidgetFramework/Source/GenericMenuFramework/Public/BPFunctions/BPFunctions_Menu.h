...
public:
	...
	static GENERICMENUFRAMEWORK_API UMenuCollection* RegisterMenuCollectionByClass(APlayerController* PlayerController, UPARAM(meta=(AllowAbstract="false")) TSubclassOf<UMenuCollection> InMenuCollectionClass, bool bBuildMenu = true);
