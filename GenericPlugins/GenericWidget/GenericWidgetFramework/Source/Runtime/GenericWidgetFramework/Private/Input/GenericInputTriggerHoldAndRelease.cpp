...
#include "Input/GenericInputTriggerHoldAndRelease.h"

EGenericInputTriggerState UGenericInputTriggerHoldAndRelease::UpdateStateNative(const FGenericInputTriggerContext& TriggerContext)
{
	...
	if (TriggerContext.bWasPressed)
	{
		...
		HeldDuration = 0.0f;
		return ReleasedHeldDuration >= HoldTimeThreshold ? EGenericInputTriggerState::Triggered : EGenericInputTriggerState::None;
	}
