...
void UK2Node_SaveStructToJsonFile::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
	...
	if (ActionRegistrar.IsOpenForRegistration(Action))
	{
		...
		{
			UK2Node_SaveStructToJsonFile* Node = CastChecked<UK2Node_SaveStructToJsonFile>(NewNode);
